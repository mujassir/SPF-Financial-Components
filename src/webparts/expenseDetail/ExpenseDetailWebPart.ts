...
import * as strings from 'ExpenseDetailWebPartStrings';
import ExpenseDetail from './components/ExpenseDetail';
import { IExpenseDetailProps } from './components/IExpenseDetailProps';
...
export interface IExpenseDetailWebPartProps {
...
export default class ExpenseDetailWebPart extends BaseClientSideWebPart<IExpenseDetailWebPartProps> {

  public render(): void {
    const element: React.ReactElement<IExpenseDetailProps> = React.createElement(
      ExpenseDetail,
      {
